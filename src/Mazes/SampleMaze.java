...
public class SampleMaze {
  ...
  public SampleMaze(int aDimension) {
      // Initialize
      this(aDimension, aDimension);
  }
  // constructor
  public SampleMaze(int xDimension, int yDimension) {
  ...
  public void updateGrid() {
      char backChar = '1', wallChar = '1', cellChar = '0', pathChar = '*';
      // fill background
  ...
  public static void main(String[] args) {
      SampleMaze maze = new SampleMaze(20);
      maze.solve();
      maze.draw();
  }
}
